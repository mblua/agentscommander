# Issue 59 Dev-Rust Plan Request
...
- Add helper scripts under `scripts/`: `task-new.ps1` and `gh-message.ps1`. Optional `.sh` wrappers only if justified.
